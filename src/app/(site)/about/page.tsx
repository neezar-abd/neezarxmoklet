...
export const metadata: Metadata = {
  title: 'Tentang Neezar Abdurrahman Ahnaf Abiyyi (Neezar Abd) — Profil, Keahlian, dan Kontak',
  description: 'Profil resmi Neezar Abdurrahman Ahnaf Abiyyi (Neezar Abd). Software Engineer dari Probolinggo yang berfokus pada Next.js/React, TypeScript, Tailwind CSS, dan MongoDB/Firebase.',
  keywords: ['Neezar Abd', 'Neezar Abdurrahman Ahnaf Abiyyi', 'Software Engineer', 'Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'MongoDB', 'Firebase', 'Probolinggo'],
  openGraph: {
    title: 'Tentang Neezar Abdurrahman Ahnaf Abiyyi (Neezar Abd) — Profil, Keahlian, dan Kontak',
    description: 'Software Engineer dari Probolinggo yang berfokus pada Next.js/React, TypeScript, Tailwind CSS, dan MongoDB/Firebase.',
    type: 'profile',
    locale: 'id_ID',
  },
  alternates: {
